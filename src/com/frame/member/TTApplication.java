...
public class TTApplication extends Application {
	...
	public void disPlayImageDef(String uri, ImageView imageAware) {
		if(!TextUtils.isEmpty(uri)){
			ImageLoader.getInstance().displayImage(uri, imageAware,
					getCustomDisplayOptions(true, true));
		}
	}
		...
		ImageLoader.getInstance().loadImage(url,
				...
				new ImageLoadingListener() {
					...
					public void onLoadingComplete(String arg0, View arg1,
						...
						imageAware.setImageBitmap(BitmapUtil
								.toRoundBitmap(arg2));
					}
	...
	public void disLoaderImageDef(String url, ImageLoadingListener listener) {
		ImageLoader.getInstance().loadImage(url,
				getCustomDisplayOptions(true, true), listener);
	}
	...
	@SuppressWarnings("deprecation")
	private static DisplayImageOptions getCustomDisplayOptions(
			boolean isCacheInMemory, boolean isCacheOnDisc) {
		...
		DisplayImageOptions options = builder.cacheInMemory(isCacheInMemory)
				.cacheOnDisc(isCacheOnDisc).bitmapConfig(Bitmap.Config.RGB_565)
