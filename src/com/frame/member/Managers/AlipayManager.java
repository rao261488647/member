...
import com.frame.member.Utils.SignUtils;
...
public class AlipayManager {
	...
	public AlipayManager(Activity context) {
	 ...
	 * 
	 */
	public void pay(final Handler mHandler,final String payInfo) {
//		if (TextUtils.isEmpty(PARTNER) || TextUtils.isEmpty(RSA_PRIVATE)
//				|| TextUtils.isEmpty(SELLER)) {
//			Toast.makeText(context, "缺少配置", 0).show();
//			return;
//		}
