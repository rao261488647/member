...
public class XRTextView extends TextView{ 
	 private final String namespace = "cookies.android.TextView"; 
	 private String text; 
	 ...
	 public XRTextView(Context context, AttributeSet attrs) { 
	  ...
	  textColor = attrs.getAttributeIntValue(namespace, "textColor",0xff5c5c5c);//字体颜色 
	  ...
	  paintColor.setColor(0xff5c5c5c); 
	 } 
