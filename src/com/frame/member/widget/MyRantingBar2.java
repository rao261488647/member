...
public class MyRantingBar2 extends LinearLayout implements View.OnClickListener {
	...
	public MyRantingBar2(Context context) {
		super(context);
		this.context = context;
		init();
	}

	public MyRantingBar2(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
		init();
	}

	public MyRantingBar2(Context context, AttributeSet attrs, int defStyle) {
	...
	private void init() {
        ...
        View viewRoot = inflater.inflate(R.layout.layout_my_rantingbar2, this);
