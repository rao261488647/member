...
class SlidingTabStrip extends LinearLayout {
	...
	private static final int DEFAULT_SELECTED_INDICATOR_COLOR = 0xFF47A5E5;
	...
	SlidingTabStrip(Context context, AttributeSet attrs) {
		...
		// * density);
		// mBottomBorderThickness = CommonUtil.dip2px(mContext, 2);
		mBottomBorderPaint = new Paint();
		mBottomBorderPaint.setColor(mDefaultBottomBorderColor);

		mSelectedIndicatorThickness = (int) (SELECTED_INDICATOR_THICKNESS_DIPS * density);
		// mSelectedIndicatorThickness = CommonUtil.dip2px(mContext, 2);
...
//			int color = Color.WHITE;
			...
			if (mSelectionOffset >= 0f
				...
				int cur_item = mSelectedPosition + 1;
				if (cur_item >= getChildCount())
					cur_item = getChildCount() - 1;
				// View nextTitle = getChildAt(mSelectedPosition + 1);
				View nextTitle = getChildAt(cur_item);
		...
		// canvas.drawRect(0, height - mBottomBorderThickness, getWidth(),
		// height, mBottomBorderPaint);
	}
