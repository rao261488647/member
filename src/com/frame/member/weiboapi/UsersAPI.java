...
package com.frame.member.weiboapi;
...
/**
 * 该类封装了用户接口�??
 * 详情请参�?<a href="http://t.cn/8F1n1eF">用户接口</a>
 * 
 * @author SINA
 * @since 2014-03-03
 */
public class UsersAPI extends AbsOpenAPI {
    ...
    /**
     * 通过个�?�化域名获取用户资料以及用户�?新的�?条微博�??
     * 
     * @param domain   �?要查询的个�?�化域名（请注意：是http://weibo.com/xxx后面的xxx部分�?
     * @param listener 异步请求回调接口
     */
     ...
     * 批量获取用户的粉丝数、关注数、微博数�?
     * 
     * @param uids     �?要获取数据的用户UID，多个之间用逗号分隔，最多不超过100�?
     * @param listener 异步请求回调接口
     */
    ...
    /**
     * -----------------------------------------------------------------------
     * 请注意：以下方法�?均同步方法�?�如果开发�?�有自己的异步请求机制，请使用该函数�?
     * -----------------------------------------------------------------------
     */
