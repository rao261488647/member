...
public class StudentCommentsAdapter extends BaseAdapter{
	private Context mContext;
	private List<StudentCommentsResult> list_name = new ArrayList<StudentCommentsResult>();
	
	public StudentCommentsAdapter(Context context,List<StudentCommentsResult> list_name){
	...
	@Override
	public StudentCommentsResult getItem(int position) {
	...
	public View getView(int position, View view, ViewGroup viewGroup) {
		...
		final StudentCommentsResult result = list_name.get(position);
		if(view == null){
		...
		holder.tv_member_level.setText("LV."+result.memberLevel);
