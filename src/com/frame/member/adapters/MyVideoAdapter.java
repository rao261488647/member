...
public class MyVideoAdapter extends BaseAdapter{
	...
	private List<MyVideoResult> list;

	public MyVideoAdapter(Context context,List<MyVideoResult> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		final MyVideoResult result = list.get(position);
		if(convertView == null){
		...
		holder.tv_attention_button.setVisibility(8);
