...
public class MyCollectActivity extends BaseActivity implements OnClickListener {
	 ...
	 private MyCollectCoachAdapter teacherAdapter;
...
//		tv_title.setText("我的收藏");
		leftBtn = (LinearLayout)findViewById(R.id.my_collect_left_btn);
		rightBtn = (LinearLayout)findViewById(R.id.my_collect_right_btn);
		leftText = (TextView)findViewById(R.id.my_collect_left_text);
		rightText = (TextView)findViewById(R.id.my_collect_right_text);
		left_back = (ImageView)findViewById(R.id.my_collect_back);
...
//		iv_title_back.setVisibility(0);
	...
	private void changeFrag() {
		...
		if (mCurFrag == null) {
			...
			if(!(mCurFrag instanceof MainFrag))
				transaction.add(R.id.my_collect_framelayout, mCurFrag, curFragTag).commit();
		} else {
	...
	public void onClick(View v) {
		switch (v.getId()) {
		// 注意点击的控件id
		case R.id.my_collect_left_btn:
			checkTabChange(0);
			break;
		case R.id.my_collect_right_btn:
			checkTabChange(1);
			break;
